...
> Xem thêm: Chi tiết về cách TreeSet và TreeMap sử dụng Comparable để sắp xếp và kiểm tra trùng lặp, được trình bày chi tiết trong [Ch.19 - Collections Framework](../../no19_collections_framework/theory/03-treeset-concepts.md).
