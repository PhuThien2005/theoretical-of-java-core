...
> Xem thêm:
> - Cơ chế Monitor Lock của `synchronized`: [Ch.29 - Synchronized](../../no29_synchronization_concurrency/theory/01-synchronized-method-concepts.md)
> - Thread Safety và Memory Visibility của `volatile`: [Ch.29 - Deadlock & Volatile](../../no29_synchronization_concurrency/theory/02-deadlock-concepts.md)
