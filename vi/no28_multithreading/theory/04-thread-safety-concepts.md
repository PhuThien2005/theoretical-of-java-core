...
> Xem thêm: Chi tiết về cơ chế khóa (Locking) và Synchronization, được trình bày chi tiết trong [Ch.29 - Synchronization Concurrency](../../no29_synchronization_concurrency/README.md).
...
> Xem thêm: Ứng dụng Double-checked locking và từ khóa volatile trong thực tế, được trình bày chi tiết trong [Ch.43 - Design Patterns](../../no43_design_patterns/theory/01-singleton-concepts.md).
