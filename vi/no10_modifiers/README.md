...
- Từ khóa đặc tả không truy cập (Non-access modifier):
  - static
  - final
  - abstract → _Học sâu tại:_ [Ch.09 - OOP](../../no09_oop/README.md)
  - synchronized → _Học sâu tại:_ [Ch.29 - Synchronization Concurrency](../../no29_synchronization_concurrency/theory/01-synchronized-method-concepts.md)
  - volatile → _Học sâu tại:_ [Ch.29 - Synchronization Concurrency](../../no29_synchronization_concurrency/README.md)
  - transient → _Học sâu tại:_ [Ch.26 - IO](../../no26_io/README.md)
  - native
  - strictfp
...
- Biến final (Final variable) → _Học sâu tại:_ [Ch.21 - Lambda Expression](../../no21_lambda_expression/README.md)
