...
JUnit là một framework kiểm thử Java để viết và chạy các bài kiểm thử tự động.
...
- **Nhầm lẫn phổ biến**: Người học thường ghi nhớ `JUnit` như một từ vựng nhưng không thể giải thích nó giải quyết vấn đề gì hoặc làm thay đổi quy tắc nào.
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `JUnit` thay đổi, cho phép, từ chối hay làm rõ điều gì?
...
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `test case` thay đổi, cho phép, từ chối hay làm rõ điều gì?
...
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `assertion` thay đổi, cho phép, từ chối hay làm rõ điều gì?
...
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `fixture` thay đổi, cho phép, từ chối hay làm rõ điều gì?

## Mockito

Mockito là một framework giả lập (mocking framework) được sử dụng để cô lập các đơn vị đang được kiểm thử.

- **Tại sao điều này quan trọng**: Nó quan trọng vì các bài kiểm thử giúp bảo vệ hành vi của hệ thống khi có sự thay đổi. Một điểm nhầm lẫn phổ biến là đi kiểm thử các chi tiết triển khai thay vì kiểm thử hành vi có thể quan sát được.
- **Nhầm lẫn phổ biến**: Người học thường ghi nhớ `Mockito` như một từ vựng nhưng không thể giải thích nó giải quyết vấn đề gì hoặc làm thay đổi quy tắc nào.
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `Mockito` thay đổi, cho phép, từ chối hay làm rõ điều gì?
...
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `mock object` thay đổi, cho phép, từ chối hay làm rõ điều gì?
...
- **Ví dụ nhỏ**: Khi đọc mã nguồn, hãy tự hỏi: `code coverage` thay đổi, cho phép, từ chối hay làm rõ điều gì?
