...
> Xem thêm: Ứng dụng thực tế của Inheritance trong cây phân cấp ngoại lệ của Java, được trình bày chi tiết trong [Ch.12 - Exception Handling](../../no12_exception_handling/README.md).
