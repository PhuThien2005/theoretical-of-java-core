...
> Xem thêm:
> - Cú pháp và cách sử dụng Lambda Expression để triển khai Functional Interface: [Ch.21 - Lambda Expression](../../no21_lambda_expression/README.md)
> - Ứng dụng của Functional Interface trong xử lý dữ liệu tập hợp: [Ch.23 - Stream API](../../no23_stream_api/README.md)
