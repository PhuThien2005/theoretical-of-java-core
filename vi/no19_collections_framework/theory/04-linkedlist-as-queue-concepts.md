...
- **`LinkedList as Queue`** — LinkedList as Queue: Cung cấp các quy tắc và cơ chế hoạt động cụ thể trong Java.
- **`FIFO`** — FIFO: Cung cấp các quy tắc và cơ chế hoạt động cụ thể trong Java.
- **`LIFO`** — LIFO: Cung cấp các quy tắc và cơ chế hoạt động cụ thể trong Java.
- **`HashMap`** — HashMap: Cung cấp các quy tắc và cơ chế hoạt động cụ thể trong Java.
- **`LinkedHashMap`** — LinkedHashMap: Cung cấp các quy tắc và cơ chế hoạt động cụ thể trong Java.
- **`TreeMap`** — TreeMap: Cung cấp các quy tắc và cơ chế hoạt động cụ thể trong Java.
...
> Xem thêm: Sự liên kết chặt chẽ và nguyên tắc (contract) giữa equals và hashCode, được trình bày chi tiết trong [Ch.14 - Object Class](../../no14_object_class/theory/02-contract-of-equals-concepts.md).
