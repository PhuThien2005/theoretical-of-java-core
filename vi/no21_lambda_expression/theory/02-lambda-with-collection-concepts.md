...
> Xem thêm: Ứng dụng mạnh mẽ của Lambda trong việc thao tác và xử lý Collection, được trình bày chi tiết trong [Ch.23 - Stream API](../../no23_stream_api/theory/01-what-is-stream-concepts.md).
