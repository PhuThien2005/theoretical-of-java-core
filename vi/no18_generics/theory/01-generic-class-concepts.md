...
> Xem thêm: Sự kết hợp chặt chẽ giữa Generics và Java Collections Framework, được trình bày chi tiết trong [Ch.19 - Collections Framework](../../no19_collections_framework/README.md).
