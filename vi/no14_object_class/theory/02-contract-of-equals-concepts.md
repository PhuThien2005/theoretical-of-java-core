...
> Xem thêm: Tại sao HashMap cần `hashCode` và `equals`, được trình bày chi tiết trong [Ch.19 - Collections Framework](../../no19_collections_framework/theory/01-what-is-the-collection-framework-concepts.md).
