...
> Xem thêm: Chi tiết về nguyên lý hoạt động của HashMap và hợp đồng khóa (Key Contract), được trình bày chi tiết trong [Ch.19 - Collections Framework](../../no19_collections_framework/theory/04-linkedlist-as-queue-concepts.md).
