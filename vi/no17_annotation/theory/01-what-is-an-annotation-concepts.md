...
> Xem thêm: Chi tiết về Cơ chế Phản Chiếu (Java Reflection API) dùng để truy vấn Annotation ở thời điểm chạy, được trình bày chi tiết trong [Ch.31 - Reflection](../../no31_reflection/README.md).
