...
> Xem thêm: Các đặc tính cốt lõi của Lập trình Hướng đối tượng (OOP) tạo nền tảng cho các nguyên tắc SOLID, được trình bày chi tiết trong [Ch.09 - OOP](../../no09_oop/README.md).
