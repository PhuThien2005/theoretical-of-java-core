...
> Xem thêm: Chi tiết về các đặc tính của tuần tự hóa và NotSerializableException, được trình bày chi tiết trong [Ch.26 - IO](../../no26_io/theory/03-serialization-concepts.md).
