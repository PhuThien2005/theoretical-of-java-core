...
> Xem thêm: Mối quan hệ giữa Heap và Stack trong quản lý bộ nhớ, được trình bày chi tiết trong [Ch.13 - Memory Management](../../no13_memory_management/theory/01-stack-concepts.md).
...
> Xem thêm: Từ khóa `native` dùng để định nghĩa các phương thức bản địa trong mã Java, được trình bày chi tiết trong [Ch.10 - Access Modifiers](../../no10_modifiers/theory/02-abstract-concepts.md).
...
> Xem thêm: Chi tiết về các loại ClassLoader và quá trình tải lớp, được trình bày chi tiết trong [Ch.32 - Classloader](../../no32_classloader/theory/01-class-loading-process-concepts.md).
