...
> Xem thêm: Chi tiết về tính hiệp biến của mảng (Array Covariance) và nguyên nhân gây ra ArrayStoreException khi so sánh với Generics, được trình bày chi tiết trong [Ch.18 - Generics](../../no18_generics/theory/generics.md).
