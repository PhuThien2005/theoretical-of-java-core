...
> Xem thêm: Chi tiết về cấu tạo của Annotation và nguyên lý RetentionPolicy.RUNTIME, được trình bày chi tiết trong [Ch.17 - Annotation](../../no17_annotation/theory/01-what-is-an-annotation-concepts.md).
