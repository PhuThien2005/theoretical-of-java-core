...
basic_rows = [
    [
        ...
        "26-io/theory/01-file-concepts.md",
        "java::core::io"
    ],
    [
        "io-basic-002",
    ...
    [
        ...
        "26-io/theory/02-bufferedinputstream-concepts.md",
        "java::core::io"
    ],
    [
        "io-basic-022",
    ...
    [
        ...
        "26-io/theory/03-serialization-concepts.md",
        "java::core::io"
    ],
    [
        "io-basic-034",
...
code_rows = [
    [
        ...
        "26-io/README.md | https://docs.oracle.com/javase/tutorial/essential/io/",
...
write_tsv(
    "/home/fhu_thjen/projects/learning-java/26-io/anki/basic.tsv",
    ["ID", "Front", "Back", "Source", "Tags"],
    basic_rows
)

write_tsv(
    "/home/fhu_thjen/projects/learning-java/26-io/anki/basic-extra.tsv",
    ["ID", "Front", "Back", "Extra", "Source", "Tags"],
    extra_rows
)

write_tsv(
    "/home/fhu_thjen/projects/learning-java/26-io/anki/cloze.tsv",
    ["ID", "Text", "Extra", "Source", "Tags"],
    cloze_rows
)

write_tsv(
    "/home/fhu_thjen/projects/learning-java/26-io/anki/code-question.tsv",
