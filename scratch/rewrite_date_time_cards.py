...
basic_rows = [
    [
        ...
        "no25_date_time_api/theory/01-date-concepts.md",
    ...
    [
        ...
        "no25_date_time_api/theory/02-period-concepts.md",
        "java::core::date-time-api"
    ],
    [
...
code_rows = [
    [
        ...
        "no25_date_time_api/README.md | https://docs.oracle.com/javase/tutorial/datetime/",
...
write_tsv(
    "/home/fhu_thjen/projects/learning-java/no25_date_time_api/anki/basic.tsv",
    ["ID", "Front", "Back", "Source", "Tags"],
    basic_rows
)

write_tsv(
    "/home/fhu_thjen/projects/learning-java/no25_date_time_api/anki/cloze.tsv",
    ["ID", "Text", "Extra", "Source", "Tags"],
    cloze_rows
)

write_tsv(
    "/home/fhu_thjen/projects/learning-java/no25_date_time_api/anki/code-question.tsv",
