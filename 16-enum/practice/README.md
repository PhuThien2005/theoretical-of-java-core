...
#### Directory Structure
- [OrderStatusWorkflow.java (Starter Code)](file:///home/fhu_thjen/projects/learning-java/16-enum/practice/order-status-workflow/src/OrderStatusWorkflow.java)
- [OrderStatusWorkflowTest.java (Tests)](file:///home/fhu_thjen/projects/learning-java/16-enum/practice/order-status-workflow/test/OrderStatusWorkflowTest.java)
- [OrderStatusWorkflow.java (Solution)](file:///home/fhu_thjen/projects/learning-java/16-enum/practice/order-status-workflow/solution/OrderStatusWorkflow.java)
...
#### Directory Structure
- [CardDeckSimulator.java (Starter Code)](file:///home/fhu_thjen/projects/learning-java/16-enum/practice/card-deck-simulator/src/CardDeckSimulator.java)
- [CardDeckSimulatorTest.java (Tests)](file:///home/fhu_thjen/projects/learning-java/16-enum/practice/card-deck-simulator/test/CardDeckSimulatorTest.java)
- [CardDeckSimulator.java (Solution)](file:///home/fhu_thjen/projects/learning-java/16-enum/practice/card-deck-simulator/solution/CardDeckSimulator.java)
...
```bash
python3 scripts/verify_exercise.py 16-enum
```
